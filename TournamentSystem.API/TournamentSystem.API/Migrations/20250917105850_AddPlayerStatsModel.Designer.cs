...
namespace TournamentSystem.API.Migrations
{
    ...
    [Migration("20250917105850_AddPlayerStatsModel")]
    partial class AddPlayerStatsModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TournamentSystem.API.Models.PlayerStats", b =>
                {
            ...
            modelBuilder.Entity("TournamentSystem.API.Models.Transfer", b =>
                {
            ...
            modelBuilder.Entity("TournamentSystem.API.Models.PlayerStats", b =>
                {
                    b.HasOne("TournamentSystem.API.Models.Player", "Player")
                        .WithMany()
            ...
            modelBuilder.Entity("TournamentSystem.API.Models.Transfer", b =>
                {
                    b.HasOne("TournamentSystem.API.Models.Team", "FromTeam")
                        .WithMany()
                    ...
                    b.HasOne("TournamentSystem.API.Models.Team", "ToTeam")
                        .WithMany()
